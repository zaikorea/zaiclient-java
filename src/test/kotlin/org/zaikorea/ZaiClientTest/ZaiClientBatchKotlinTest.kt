...
import org.zaikorea.ZaiClient.request.ViewEventBatch
import org.zaikorea.ZaiClient.exceptions.BatchSizeLimitExceededException
import org.zaikorea.ZaiClient.request.LikeEventBatch
import org.zaikorea.ZaiClient.request.CartaddEventBatch
import org.zaikorea.ZaiClient.request.PurchaseEventBatch
import org.zaikorea.ZaiClient.request.RateEventBatch
...
class ZaiClientBatchKotlinTest {
    ...
    @Test
    fun testAddViewEventBatch() {
        val userId = generateUUID()
        try {
            val eventBatch = ViewEventBatch(userId)
            val NUM = 10
    ...
    @Test
    fun testAddViewEventBatchManualTime() {
        val userId = generateUUID()
        val timestamp = unixTimestamp.toLong()
        try {
            val eventBatch = ViewEventBatch(userId, timestamp.toDouble())
            val NUM = 10
            for (i in 0 until NUM) {
                val itemId = generateUUID()
                eventBatch.addEventItem(itemId)
    ...
    @Test
    fun testDeleteItemViewEventBatch() {
        val userId = generateUUID()
    ...
    @Test
    fun testAddViewEventBatchExceedMaxLimit() {
        val userId = generateUUID()
        try {
            val eventBatch = ViewEventBatch(userId)
    ...
    @Test
    fun testAddLikeEventBatch() {
        val userId = generateUUID()
        try {
            val eventBatch = LikeEventBatch(userId)
            val NUM = 10
            for (i in 0 until NUM) {
                val itemId = generateUUID()
                eventBatch.addEventItem(itemId)
    ...
    @Test
    fun testAddLikeEventBatchManualTime() {
        val userId = generateUUID()
        val timestamp = unixTimestamp.toLong()
        try {
            val eventBatch = LikeEventBatch(userId, timestamp.toDouble())
            val NUM = 10
            for (i in 0 until NUM) {
                val itemId = generateUUID()
                eventBatch.addEventItem(itemId)
    ...
    @Test
    fun testDeleteItemLikeEventBatch() {
        val userId = generateUUID()
        var itemId = generateUUID()
        try {
            val eventBatch = LikeEventBatch(userId)
    ...
    @Test
    fun testAddLikeEventBatchExceedMaxLimit() {
        val userId = generateUUID()
        try {
            val eventBatch = LikeEventBatch(userId)
            val NUM = Config.batchRequestCap + 1
    ...
    @Test
    fun testAddCartaddEventBatch() {
        val userId = generateUUID()
        try {
            val eventBatch = CartaddEventBatch(userId)
            val NUM = 10
            for (i in 0 until NUM) {
                val itemId = generateUUID()
                eventBatch.addEventItem(itemId)
    ...
    @Test
    fun testAddCartaddEventBatchManualTime() {
        val userId = generateUUID()
        val timestamp = unixTimestamp.toLong()
        try {
            val eventBatch = CartaddEventBatch(userId, timestamp.toDouble())
            val NUM = 10
            for (i in 0 until NUM) {
                val itemId = generateUUID()
                eventBatch.addEventItem(itemId)
    ...
    @Test
    fun testDeleteItemCartaddEventBatch() {
        val userId = generateUUID()
        var itemId = generateUUID()
        try {
            val eventBatch = CartaddEventBatch(userId)
    ...
    @Test
    fun testDeleteCartaddEventBatch() {
        val userId = generateUUID()
        try {
            val eventBatch = CartaddEventBatch(userId)
            val NUM = 10
    ...
    @Test
    fun testAddCartaddEventBatchExceedMaxLimit() {
        val userId = generateUUID()
        try {
            val eventBatch = CartaddEventBatch(userId)
            val NUM = Config.batchRequestCap + 1
    ...
    @Test
    fun testAddRateEventBatch() {
        val userId = generateUUID()
        try {
            val eventBatch = RateEventBatch(userId)
            val NUM = 10
            for (i in 0 until NUM) {
                val itemId = generateUUID()
    ...
    @Test
    fun testAddRateEventBatchManualTime() {
        val userId = generateUUID()
        val timestamp = unixTimestamp.toLong()
        try {
            val eventBatch = RateEventBatch(userId, timestamp.toDouble())
            val NUM = 10
            for (i in 0 until NUM) {
                val itemId = generateUUID()
                val rate = generateRandomDouble(0, 5)
    ...
    @Test
    fun testDeleteItemRateEventBatch() {
        val userId = generateUUID()
        var itemId = generateUUID()
        var rate: Double
        try {
    ...
    @Test
    fun testDeleteItemRateEventBatchWithRate() {
        val userId = generateUUID()
        var itemId = generateUUID()
        var rate = generateRandomDouble(0, 5)
        try {
            val eventBatch = RateEventBatch(userId)
            val NUM = 10
            for (i in 0 until NUM) {
    ...
    @Test
    fun testAddRateEventBatchExceedMaxLimit() {
        val userId = generateUUID()
        try {
            val eventBatch = RateEventBatch(userId)
            val NUM = Config.batchRequestCap + 1
